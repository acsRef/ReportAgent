...
class ContextRuntime:
    ...
    async def build(
        ...
        *,
        ...
        # （memory_type ∈ semantic_fact/insight → kind="semantic"），preference 类
        # （图表/格式偏好）不得进入 SQL 上下文，防止"柱状图"类偏好污染 SQL 语义
        # （Report 档 preference 才是主消费方；Requirement 档偏好影响需求理解，均不收窄）。
